---
name: okr-framework
description: "Define and achieve ambitious goals using Objectives and Key Results methodology. Use for: goal setting, strategic alignment, measuring progress, quarterly planning, team objectives, company-wide alignment, tracking key results, and performance management."
---
...
- **Key Results**:
  1. Achieve 4.5+ star rating in app stores
  2. Reach 500K downloads in first quarter
  3. Achieve 40% daily active user rate
  4. Reduce app crash rate to <0.1%
...
**Number**: 3-5 Objectives
**Purpose**: Strategic direction and alignment

**Example**:
- **Objective**: Become market leader in enterprise SaaS
- **Key Results**:
  1. Achieve $100M ARR
  2. Sign 50 enterprise customers (>$500K contracts)
  3. Achieve 95% customer retention rate

### Team OKRs

**Scope**: Department or team
**Set by**: Team with manager
**Number**: 3-5 Objectives per team
**Purpose**: Support company OKRs, team-specific goals
...
- **Key Results**:
  ...
  3. Deploy to production 20+ times per week
  4. Reduce critical bugs by 50%

### Individual OKRs

**Scope**: Individual contributor
**Set by**: Individual with manager
**Number**: 3-5 Objectives
**Purpose**: Personal development, support team OKRs
...
2. Teams draft OKRs aligned with company goals
3. Individuals draft OKRs aligned with team goals
4. Review and refine for alignment

**Week 3-11: Execution**
1. Weekly check-ins on progress
2. Update confidence levels
3. Address blockers
4. Adjust as needed (with justification)

**Week 12: Review and Reflect**
1. Score OKRs (0.0 to 1.0)
2. Reflect on what worked/didn't
3. Celebrate achievements
4. Learn from misses
5. Feed learnings into next quarter
...
**Bad**: "Conduct 10 customer interviews"
**Good**: "Increase customer satisfaction score from 7.5 to 8.5"
